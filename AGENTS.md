...
the accepted `ven-c87` Eon workspace slice. `VEN-C8` remains partially proved;
its exact header and interaction proofs are indexed in `docs/CONTRACTS.md`,
with fractional native scale still open. `VEN-C18` is proved through Venus
