...
| `VEN-C3` | Venus is transient: closing or crashing the client does not own or terminate the Orbit session, and reopening materializes its coherent current state. | Planned | Orbit `ORB-C1`, `ORB-C2`, `ORB-C3`, `ORB-C4`, and `ORB-C7` at accepted proof `e4fde443e625180d7332eff4dff366f64bee30a8` | None | Native lifecycle and reconnect evidence remain unimplemented. |
| `VEN-C4` | Venus gives bounded, explicit client UX for attach rejection, protocol incompatibility, invalid frames, and Orbit loss rather than hanging or silently inventing state. | Planned | Orbit `ORB-C3`, `ORB-C4`, and `ORB-C7` at accepted proof `e4fde443e625180d7332eff4dff366f64bee30a8` | None | Failure states and recovery UX remain unimplemented. |
