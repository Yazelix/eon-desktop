...
| `VEN-C17` | Venus accepts one bounded caller-owned application ID before window creation and maps it to the native Wayland app ID without changing terminal-authored titles. | Planned | Eon owns the selected identity; exact winit 0.30.13 commit `fb45fbf901fbe70cc9a877b5d651d0b60c206b08` owns the Wayland mapping. | None. | Native installed grouping remains to be proved. |
