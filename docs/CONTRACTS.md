...
| `VEN-C2` | Venus owns native interaction collection and sends only Orbit's semantic input and resize messages. | Proved | Orbit `ORB-C5` and canonical ORBS v1 at accepted proof `c905bf9610581747f1b07565814b501ca66cfaa6` | Venus `91b1602d3733e3dbfaa988acb6a8bc28aa8f186d`; semantic mapping, focus-loss reset, transactional held-button tracking, ordered resize recovery before geometry-dependent pointer input, canonically encoded surface-bound checks including full-cell lower bounds, notice-source recovery, failure-frame ordering, local-failure ownership, typed transport, and terminal-event checks. | No initial-slice gap. Candidate-list IMEs and Wayland remain manual quality surfaces. |
