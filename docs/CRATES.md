...
| Orbit protocol consumer | Exact Git revision `69c402737799f03e615473956954a043647a4713` of the dependency-free, publish-false `orbit-protocol` 0.1.0 package | Active | Orbit alone owns ORBS v5, ORBF v1, semantic values, history, selection, typed wheel outcomes, copied text, terminal clipboard effects, read-only pane metadata, bounds, revision reduction, and the accepted lifecycle contracts. Venus keeps no mirror, adapter, preview state, or kinetic policy. |
